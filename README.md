...
<b>.NET 기반 Windows Application</b>을 구현하고, <b>Unity</b>를 활용해 모바일 콘텐츠와 게임을 개발하며 C# 경험을 쌓았습니다.<br>
...
* Windows GUI 환경에서 사용 가능하도록 사용자 인터페이스 연결
...
### 사용 기술과 언어
* Unity 3D (2021.3.21f1 → 2022.3.3f1), C#
